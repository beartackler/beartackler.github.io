...
export const SCENES: Scene[] = [
  ...
  { id: 'sisyphus', beat: { enter: 0.6, hold: 0.6, exit: 0.4 }, quote: 'sisyphus' },
  { id: 'pandora', beat: { enter: 0.6, hold: 0.6, exit: 0.4 }, quote: 'pandora' },
  { id: 'walle', beat: { enter: 0.6, hold: 0.6, exit: 0.4 }, quote: 'walle' },
  { id: 'dorian', beat: { enter: 0.6, hold: 0.7, exit: 0.3 }, quote: 'dorian' },
];
